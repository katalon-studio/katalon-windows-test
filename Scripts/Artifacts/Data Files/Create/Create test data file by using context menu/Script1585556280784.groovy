 ...
 * 2. Open `New Test Data` dialog by using context menu
...
Windows.comment('2. Open New Test Data dialog by using context menu')
Windows.sleep(1000L)
...
Windows.comment('3. Input test Data info and press OK')
Windows.sleep(1000L)
