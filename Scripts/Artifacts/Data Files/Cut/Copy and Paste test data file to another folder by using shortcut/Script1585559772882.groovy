 ...
 * 4. Paste the cut test data =to naother folder by using shortcut key [Control + V]
 * 5. Verify the cut test data is appeared under the new folder
...
Windows.comment('4. Cut the new test data by using shortcut key [Control + C]')
...
Windows.comment('5. Paste the cut test data to another foler by using shortcut key [Control + V]')
