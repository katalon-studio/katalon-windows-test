 ...
 * 4. Paste the cut test data at the same folder by using context menu [Right click ->Paste]
...
Windows.comment('4. Paste the cut test data at the same foler by using context menu [Right click ->Paste]')
TestsExplorerKeyword.openContextMenuAtTreeItem(newTestDataName)
