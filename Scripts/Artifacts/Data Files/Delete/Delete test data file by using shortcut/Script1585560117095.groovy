 ...
 * 3. Delete the new test data by using shortcut key [Delete]
...
Windows.comment('3. Delete the new test data by using shortcut key [Delete]')
WebElement newTestDataTreeItem = TestsExplorerKeyword.findTreeItem(newTestDataName)
newTestDataTreeItem.click()
newTestDataTreeItem.sendKeys(Keys.DELETE)
Windows.sleep(1000L)
WindowsEnhancedKeyword.sendKeys(Keys.ENTER)

Windows.comment('4. Verify the new test data is delete')
Windows.sleep(1000L)
WebElement deletedTestDataTreeItem = TestsExplorerKeyword.findTreeItem(newTestDataName)
WindowsEnhancedKeyword.verifyElementNotPresent(deletedTestDataTreeItem, FailureHandling.STOP_ON_FAILURE)
