 ...
 * 2. Create a sample test data
 * 3. Show References by using shortcut key [Control + R]
 * 4. Verify test data references are listed under Search tab
 * 5. Delete the sample test data
...
Windows.comment('2. Create a sample test data')
TestDataKeyword.createDataFile(newTestDataName)

Windows.comment('3. Show References by using shortcut key [Control +R]')
WebElement newTestDataNameTreeItem = TestsExplorerKeyword.findTreeItem(newTestDataName)
newTestDataNameTreeItem.click()
newTestDataNameTreeItem.sendKeys(Keys.chord(Keys.CONTROL, 'r'))

Windows.comment('4. Verify test data references are listed under Search tab')
