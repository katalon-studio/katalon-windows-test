 ...
 * 3. Refresh the created test data by using context menu [Right cick ->Refresh]
...
Windows.comment('3. Refresh the new test data by using context menu [Right click ->Refresh]')
Windows.sleep(1000L)
