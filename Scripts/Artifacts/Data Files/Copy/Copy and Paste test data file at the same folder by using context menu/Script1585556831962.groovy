 ...
 * 3. Copy the new test data by using context menu [Right click ->Copy]
 * 4. Paste the copied test data at the same folder by using context menu [Right click ->Paste]
...
Windows.comment('3. Copy the new test data by using  using context mmenu [Right click -> Copy]')
...
Windows.comment('4. Paste the copied test data at the same foler by  using context mmenu [Right click -> Paste]')
TestsExplorerKeyword.openContextMenuAtTreeItem(newTestDataName)
