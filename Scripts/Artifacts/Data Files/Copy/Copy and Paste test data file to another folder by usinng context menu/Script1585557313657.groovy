 ...
 * 3. Create new folder
 * 3. Copy the new test data by using context mmenu [Right click -> Copy]
...
Windows.comment('4. Copy the new test data by using context mmenu [Right click -> Copy]')
...
Windows.comment('5. Paste the copied test data at the same folder by using context menu [Right click -> Paste]')
