 ...
 * 3. Open rename dialog by using shortcut (F2)
...
WebElement sampleExecutionProfile = TestsExplorerKeyword.findTreeItem(sampleExecutionProfileName)
sampleExecutionProfile.click()
sampleExecutionProfile.sendKeys(Keys.F2)
