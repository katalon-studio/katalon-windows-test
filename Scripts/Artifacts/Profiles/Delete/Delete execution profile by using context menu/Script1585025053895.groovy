 ...
 * 2. Create a sample execution profile
 * 3. Delete the sample execution profile by using context menu
...
Windows.comment('2. Create a sample execution profile')
ProfilesKeyword.createProfile(newExecutionProfileName)

Windows.comment('3. Delete the sample execution profile by using context menu')
Windows.sleep(1000L)
TestsExplorerKeyword.openContextMenuAtTreeItem(newExecutionProfileName)
WindowsEnhancedKeyword.sendKeys('d')
WindowsEnhancedKeyword.sendKeys(Keys.ENTER)

Windows.comment('4. Verify the sample execution profile is deleted')
Windows.sleep(1000L)
