 ...
 * 3. Get menu item delete
 * 4. Verify menu item delete is disable
...
Windows.comment('3. Get menu item delete')
WebElement deleteElement = TestsExplorerKeyword.findContextMenuItem('Delete')

Windows.comment('4. Verify menu item delete is disable')
Windows.verifyEqual(false, deleteElement.isEnabled())
