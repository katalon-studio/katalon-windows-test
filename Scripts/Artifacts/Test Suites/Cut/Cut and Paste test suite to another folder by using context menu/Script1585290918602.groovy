 ...
 * 3. Create new folder
 * 4. Cut the new test suite by using context menu [Right click -> Cut]
 * 5. Paste the cut test suite to the new folder by using context menu [Right click -> Paste]
...
Windows.comment(' 4. Cut the new test suite by using context menu [Right click -> Cut]')
Windows.sleep(1000L)
...
Windows.comment('5. Paste the cut test suite to the new folder by using context menu [Right click -> Paste]')
