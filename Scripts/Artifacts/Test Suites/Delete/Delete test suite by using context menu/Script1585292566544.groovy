 ...
 * 3. Delete the created test suite by using context menu [Right cick ->Delete]
...
Windows.comment('3. Delete the new test suite by using context menu [Right click ->Delete]')
Windows.sleep(1000L)
...
Windows.comment('4. Verify the new test suite is deleted')
Windows.sleep(1000L)
...
//Windows.comment('5. Verify the new test suite is closed')
//Windows.sleep(1000L)
//WebElement deletedTestSuiteTab = MainContentKeyword.findTabItem(newTestSuiteName)
//WindowsEnhancedKeyword.verifyElementNotPresent(deletedTestSuiteTab, FailureHandling.STOP_ON_FAILURE)
