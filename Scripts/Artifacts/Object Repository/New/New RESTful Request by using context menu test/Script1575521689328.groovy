...
Windows.setText(findWindowsObject("Object Repository/Windows/New Request Dialog/Edit_Name"), "New RESTful Request")
...
Windows.setText(findWindowsObject("Object Repository/Windows/New Request Dialog/Edit_URL"), 
	"https://sample-web-service-aut.herokuapp.com/api/users/accept-xml")
...
WindowsEnhancedKeyword.verifyElementPresent(findWindowsObject("Object Repository/Tests Explorer/TreeItem_New_RESTful_Request"), FailureHandling.STOP_ON_FAILURE)

'Verify the request tab present on main editor'
WindowsEnhancedKeyword.verifyElementPresent(findWindowsObject("Object Repository/MainPartStack/TabItem_New_RESTful_Request"), FailureHandling.STOP_ON_FAILURE)
