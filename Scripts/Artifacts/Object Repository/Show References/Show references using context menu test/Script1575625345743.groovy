...
'Switch to desktop to locate Show references menu item'
Windows.switchToDesktop()

'Click on Show references menu item'
Windows.click(findWindowsObject('Object Repository/Tests Explorer/Menu/MenuItem_Show References'))
