 ...
 * 5. Close the Containing folder and Delete the sample test case
...
WindowsEnhancedKeyword.sendKeys('oo')
...
Windows.comment('5. Close the Containing folder and Delete the sample test case')
